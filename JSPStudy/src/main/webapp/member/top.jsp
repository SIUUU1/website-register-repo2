	...
	<header>
		...
		<nav class="right-top">
			<a href="./main.jsp"><span>Home</span></a> <a
				...
				href="main.jsp?file=login"><span>로그인</span></a> <a
				href="main.jsp?file=regForm"><span>회원가입</span></a>
		</nav>
		<div class="head">
			<!-- left-top -->
			<div class="call">
		...
		<nav id="mainMenuContent" onmouseover="displayMenu('mouseover')"
			...
			<ul>
				<a href="#"><li onclick="openSignInPage(event)">로그인</li></a>
				<a href="#"><li onclick=" openRegisterPage(event)">회원가입</li></a>
