		...
		<table>
			...
			<tr>
				...
				<td class="content"><input class="request" type="password"
					...
					onkeyup="userPwCheck('keyup')"> <span id="userPwInfo"></span><br>
				</td>
			</tr>
			<tr>
				...
				<td class="content"><input type="password" name="userPwConfirm"
					...
					onblur="userPwCheck('blur')"> <span id="userPwConfirmInfo"></span><br>
				</td>
			</tr>
		</table>
		<h4>개인정보 입력</h4>
		<table>
			...
			<tr>
				...
				<td><input class="request" type="text" name="userNickName"
					...
					onkeyup="userNickNameCheck()"> <span id="userNickNameInfo"></span><br>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input class="request" type="tel" name="userTel"
					...
					<span id="userTelInfo"></span><br></td>
			</tr>
			<tr>
				...
				<td><input class="request" type="tel" name="userPhoneNum"
					...
					onkeyup="userPhoneNumCheck()"> <span id="userPhoneNumInfo"></span><br>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td id="address"><input class="request" type="text"
					...
					onclick="searchPostCode()" required>
