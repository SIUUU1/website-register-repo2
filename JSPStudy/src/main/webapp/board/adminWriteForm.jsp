...
<body>
	...
	<br>
	<form method="post" name="writeForm" action="<%=request.getContextPath()%>/board/writeProc.jsp?type=1">
		...
		<table>
			<tr>
				...
				<td class="below">
				<input type="text" size="50" maxlength="12" name="writer" id="writer" value="관리자"/>
				</td>
			</tr>
			<tr>
				<th><label for="email">이메일</label></th>
				<td class="below">
				<input type="email" name="email" id="email"size="40" maxlength="40" readonly value="<%=admin.getUserEmail()%>"> 
				</td>
			</tr>
			<tr>
				...
				<td class="below">
				 ...
				 %> <input type="text" size="50" maxlength="50" name="subject" value="공지사항"/> <%
				 }
				 %>
					</td>
			</tr>
		...
		<div class="wriButton">
			<button type="button" id="subButton" onclick="adminWriteCheck()">완료</button>
			<a href="<%=request.getContextPath()%>/member/main.jsp?middleFile=/board/boardTotalList.jsp"><button type="button">취소</button></a>
		</div>
	</form>
	<%
	} catch (Exception e) {
